...
insert into estadio (nombre, fecha_inauguracion, aforo)
...
-- Poblar tabla Equipo
INSERT INTO EQUIPO (nombre_oficial,nombre_corto,otros_nombres,ciudad,
...
CREATE OR REPLACE VIEW DATOS_LIGA_FILTRADA
...
FROM datosdb.ligahost a, EQUIPO b, EQUIPO c
...
INSERT INTO TEMPORADA_DIVISION 
...
INSERT INTO PARTIDO (TEMPORADA, DIVISION, JORNADA, EQUIPO_LOCAL,
...
CREATE OR REPLACE VIEW RESULTADOS_PARTIDO
...
FROM PARTIDO WHERE GOLES_LOCAL > GOLES_VISITANTE AND
...
FROM PARTIDO WHERE GOLES_VISITANTE > GOLES_LOCAL AND
EQUIPO_LOCAL IS NOT NULL AND
EQUIPO_VISITANTE IS NOT NULL)
UNION
